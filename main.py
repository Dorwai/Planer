...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\kitik\PycharmProjects\probaa\proba\build\assets\frame0")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # self.button_6 = CTk.CTkButton(master=self.navigation_frame,
        #     text="Календарь", corner_radius=0,
        #     image=self.image_5,
        #     hover_color=( "#578E63","#77AB85"),
        #     border_spacing=0, fg_color="#77AB85",
        #     font=("Century Gothic", 32),
        #     width=340.0, height=80.0
        # )
        # self.button_6.place(x=0.0, y=160.0,)

        self.text_cal = CTk.CTkLabel(master=self.navigation_frame,
            width=340, height=80,
            text="Календарь",
            text_color="#F4F6F4",
            font=("Century Gothic", 32),
            )
        self.text_cal.place(x=23, y=160)

        self.image_cal = CTk.CTkLabel(master=self.navigation_frame, height=80, image=self.image_5,text='')
        self.image_cal.place(x=38, y=160)
        ...
        def add_task():
            ...
            CTk.CTkButton(window, text='Добавить', font=('Times New Roman', 20),
                                     fg_color="#77AB85", bg_color="#D3E1D5", hover_color=("#578E63", "#77AB85"), command=lambda: [add(task_text.get()), dismiss(window)]).pack()
            window.grab_set()
        ...
        btn_add_task = CTk.CTkButton(mainframe, width=825, text='Добавить конспект', bg_color="#D3E1D5", font=('Times New Roman', 20),
        ...
        def add(task):
            if not task in lst:
                ...
                file.close()
                CTk.CTkButton(f, text=task, width=790, bg_color="#D3E1D5", font=('Times New Roman', 20), fg_color="#77AB85", hover_color=("#578E63","#77AB85"), command=lambda: openfile(task)).pack(side='left')
                CTk.CTkButton(f, text='✕', width=30, bg_color="#D3E1D5", font=('Times New Roman', 20), fg_color="#77AB85", hover_color=("#B9464C","#77AB85"), command=lambda: delete(task, f)).pack(side='left')
        ...
        def openfile(name):
            ...
            c = CTk.CTkButton(secframe, text='сохранить', font=('Times New Roman', 20), fg_color="#77AB85", hover_color=("#578E63","#77AB85"), command=lambda: Save(name, text_area.get('1.0', END)[:-1]))
            c.pack(anchor='e', side='right', pady=[0,9], padx=10)

            b = CTk.CTkButton(secframe, font=('Times New Roman', 20), text='назад', fg_color="#77AB85", hover_color=("#578E63","#77AB85"), command=lambda: (back(name, text_area.get('1.0', END)[:-1],
